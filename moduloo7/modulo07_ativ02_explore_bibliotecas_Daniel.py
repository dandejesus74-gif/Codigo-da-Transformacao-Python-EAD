...
print(f' Usando subtracão({num1} - {num2}):', utilidades.subtrair(num1, num2))
print(f' Usando Multiplicação({num1} * {num2}):', utilidades.multiplicar(num1, num2))
print(f' Usando divisao({num1} / {num2}):', utilidades.dividir(num1, num2))
print(f' Usando divisao_inteira({num1} // {num2}):', utilidades.divisao_inteira(num1, num2))
print(f' Usando resto_divisao({num1} % {num2}):', utilidades.resto_divisao(num1, num2))
